...
function CohortModule() {

    const { cohortcode } = useParams();

    console.log("cohortcode:", cohortcode);
    ...
    useEffect(() => {
      fetch(`http://localhost:8000/api/module/?delivered_to=${cohortcode}`)
          .then((res) => res.json())
          .then((data) => {
    ...
    return (
        <div className="container">
          <h1 className="text-primary text-center fw-bold m-4">{cohortcode} Modules</h1>
          <div className="row">
